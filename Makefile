...
SRC = src/ft_atoi.c src/ft_bzero.c src/ft_calloc.c src/ft_error.c \
	...
	src/ft_memmove.c src/ft_memset.c src/ft_printf.c src/ft_putchar.c \
	src/ft_putendl.c src/ft_putnbr.c src/ft_putnbr_base.c src/ft_putstr.c \
	src/ft_split.c src/ft_strchr.c src/ft_strdup.c src/ft_striteri.c \
